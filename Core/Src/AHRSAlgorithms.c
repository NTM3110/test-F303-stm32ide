...
static float GyroMeasError = PI * (40.0f / 180.0f);  // Gyroscope measurement error
static float GyroMeasDrift = PI * (0.0f / 180.0f);   // Gyroscope measurement drift

static float beta;  // Placeholder for beta
static float zeta;  // Placeholder for zeta
